...
CATEGORY_PATTERNS: dict[str, list[str]] = {
    ...
    "container": [r"\bdocker\b", r"\bcompose\b", r"\bpodman\b"],
    ...
    "python-dev": [r"\bpytest\b", r"\buvicorn\b", r"\bpython\b", r"\bpoetry\b", r"\buv\b"],
    "gpu": [r"\bnvidia\b", r"\bcuda\b", r"\brocm\b"],
    "auth": [r"permission denied", r"unauthorized", r"forbidden", r"token"],
